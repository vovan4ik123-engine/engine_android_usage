...
void main()
{
    ...
    fragPosLightPerspective = (MVPLightMatrix * posTransformedByBone); // transform to view space then to clip space
    ...
    gl_Position = MVPMatrix * posTransformedByBone; // transform to view space then to clip space
